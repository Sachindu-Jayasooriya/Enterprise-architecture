...
import static crud.DatabaseConnection.getConnection;
...
public class EmployeeDAO {
    ...
    public static void updateEmployee(int id, String name, String position,
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            int rowsAffected = stmt.executeUpdate();
            System.out.println(
                    "Employee updated successfully. Rows affected:" + rowsAffected);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void deleteEmployee(int id) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            int rowsAffected = stmt.executeUpdate();
            System.out.println(
                    "Employee deleted successfully. Rows affected:" + rowsAffected);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
